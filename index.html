...
<head>
    ...
    <title>Portfolio - Umar Faiz</title>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a href="#" class="nav-link">Home <span class="sr-only">(currenct)</span></a>
                        </li>
                        <li class="nav-item">
    ...
    <main class="site-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 site-title">
                        ...
                        <h1 class="title-text text-uppercase">I am Faiz</h1>
                        <h4 class="title-text text-uppercase">Full-stack Web Development</h4>
                        ...
                        <div class="experience-area">
                            ...
                            <div class="d-flex flex-row flex-wrap call-area">
                                ...
                                <div class="call-now">
                                    ...
                                    <span class="font-roboto py-2">(+62)-895-415-108-733</span>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center services-title">
                        ...
                        <p class="para">
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusantium aut nobis illum fuga
                            quidem libero voluptate totam dolor similique qui.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase font-roboto">Full-stack Web Developer</h5>
                                    <p class="card-text text-secondary">
                                        Lorem ipsum dolor sit,
                                        amet consectetur adipisicing elit.
                                        Eum fuga assumenda maiores.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <!--  ==== Start About me Area ====  -->
        <section class="about-area" id="testimonial">
            <div class="container">
